        ...
        <v-col class="d-flex align-center">
          ...
          <v-btn
            ...
            :to="{
              name: 'object',
              params:{
                objectId: object.swipe_up_goto_object
              }
            }"
            @click="this.initialize"
            :disabled="object.swipe_up_goto_object == null"
          >
          ...
          <v-btn
            ...
            :to="{
              name: 'object',
              params:{
                objectId: object.swipe_down_goto_object
              }
            }"
            @click="this.initialize"
            :disabled="object.swipe_down_goto_object == null"
          >
